...
![image of terminal showing the streaming test suite transcribing the Preamble](file:09b6a75e-783a-4190-82d0-f09f3c062641)
...
Now that you've validated you can stream WAV files and URLs to Deepgram, it's time to start the process of integrating other audio sources, so you can build something with Deepgram that's tailored to your business needs. To do this, we'll start by taking a step backâ€¦and removing Deepgram from the picture!
...
![](file:6e4a474f-cad2-4234-9b8c-a4477d8c3d3e)
...
![image of terminal showing message that websocket is receiving data](file:19190fb4-37df-424b-92fc-7aece7cb880a)
...
![image of terminal showing lines to edit to connect to Deepgram](file:300f29b8-3938-494e-a1a3-e4d32b2007a4)

Don't forget add your DG API key to the websocket headers where it says `YOUR_DG_API_KEY`.

![](file:3877c120-5df4-43bc-b967-c70329f9cc21)
